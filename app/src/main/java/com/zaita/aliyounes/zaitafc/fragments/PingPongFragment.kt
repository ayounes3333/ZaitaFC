 ...
 */
class PingPongFragment : Fragment() {

    private var recyclerView: RecyclerView? = null
    private var adapter: MembersAdapter? = null

    private fun setupRecyclerView(rootView: View) {
        recyclerView = rootView.findViewById(R.id.recyclerView_pingPongPlayers)
        adapter = MembersAdapter(TestHelper.dummyPingPongPlayers)
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        return inflater.inflate(R.layout.fragment_ping_pong, container, false)
    }
